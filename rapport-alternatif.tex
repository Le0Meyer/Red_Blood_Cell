...
&\frac{dC_{Na}^m}{dt}=\frac{Ht}{1 - Ht}\left(C_{Na}^m-\frac{dQ_{Na}}{dt}\right)\\
&\frac{dC_{K}^m}{dt}=\frac{Ht}{1 - Ht}\left(C_{K}^m-\frac{dQ_{K}}{dt}\right)\\
&\frac{dC_{A}^m}{dt}=\frac{Ht}{1 - Ht}\left(C_{A}^m-\frac{dQ_{A}}{dt}\right)\\
&\frac{dC_{HB}^m}{dt}=\frac{Ht}{1 - Ht}\left(C_{HB}^m-\frac{dQ_{H}}{dt}\right)\\
&\frac{dC_{B}^m}{dt}=\frac{Ht}{1 - Ht}\,C_{B}^m\\
&\frac{dC_{Y}^m}{dt}=\frac{Ht}{1 - Ht}\,C_{Y}^m\\
\end{empheq}
